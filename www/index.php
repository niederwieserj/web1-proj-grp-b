    ...
    <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis" style="background-image: url(&quot;/assets/images/space-1-horizontal.jpg&quot;); background-position: center; background-repeat: no-repeat; background-size: 100% auto;">
      <div class="col-lg-6 px-0">
        <h1 class="display-4 fst-italic text-white">
          How to get dogs to the moon safely
        </h1>
      ...
      <div class="col-md-6">
        <div
          ...
          <div class="col p-4 d-flex flex-column position-static">
            <strong class="d-inline-block mb-2">Gardening</strong>
            <h3 class="mb-0">How to grow good vegetables</h3>
            <div class="mb-1 text-body-secondary">Nov 12</div>
            <p class="card-text mb-auto">
              New studies clearly indicate that Jazz has a profound impact on lettuce fertility. Why is that?
              <a
              href="#"
